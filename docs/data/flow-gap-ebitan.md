...
| D4 | 步44 巴拉摩斯城取魔神之斧(0x19)+祈禱戒指(第二枚)+擊敗巴拉摩斯 | 寶箱+boss(須飛行抵達,單戰) | **R-4 已接**:CTY66→CTY65 `(8,3)` handler70，怪0x79單戰；勝 CLR flag0x29。舊「打兩次」為精訊版 bug 重試 | IDA sub_1622A + CTY65 | ✅ | 完成 |
| D5 | 步45 阿里阿罕回報+索瑪聲音 | 王城 rec98/99、CLR flag0x4d | **R-4 已接**:CTY25 sec1 `(9,7)` production region trace | IDA sub_15137 | ✅ | 完成 |
| D6 | 步46 蓋亞那洞穴跳坑下降愛列夫加特 | CTY72→CTY77→0xfe | **R-4 已接**:CTY72 hiMap subid1 到 CTY77；0xfe 到 DQ3UND `(85,67)`；KeyU 已移除 | CTY71/72/77 原始 transition | ✅ | 完成 |
