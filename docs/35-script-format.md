...
| off | 內容 | 反組譯出處 |
|---|---|---|
| +0 / +2 | **白天/黑夜兩份 NPC 表**指標(原版 `[0x526c]` 日→`+0`/夜→`+2` 選載;舊文「Y<0x12c」為誤判,見 [docs/60](60-daynight-npc-mechanism.md))| 0x4549 |
| **+6** | **設施指標表**指標(商店/旅社/教會/記錄;NPC byte4 索引;`0xffff`=無)★ docs/40 | 0x839f |
...
| +0x10/+0x11 | 地圖旗標 / `[0xd77]` 遭遇旗標(0=安全、非0=可遇敵)| docs/13 |
