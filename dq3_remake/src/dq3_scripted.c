...
/* {byte4, cty, give_item, prereq_item, require_item, milestone, before_rec, give_rec, after_rec} */
static const dq3_scripted TABLE[] = {
  /* ── 給予型(give_item != NONE)── */
  /* 拿吉米之塔 4F 老人:給盜賊鑰匙(handler L0x537f)。無前置;before 不觸發。 */
  {  12,  8, 0x55, DQ3_SC_NOITEM, DQ3_SC_NOITEM, DQ3_MS_THIEF_KEY, 54, 52, 53 },
  /* 雷貝 2F 老人:持盜賊鑰匙(開門)→ 給魔法玉(handler L0x521f)。 */
  {   7,  1, 0x58, 0x55,          DQ3_SC_NOITEM, DQ3_MS_MAGIC_BALL, 65, 60, 60 },
  /* CTY22 sect1 (3,4):給水槍 0x4b(handler L0x589f,flag 0x3c)。rec45 招呼 → 給 0x4b + rec46。 */
  {  31, 22, 0x4b, DQ3_SC_NOITEM, DQ3_SC_NOITEM, 0,                 45, 46, 45 },
  /* 龍女王城 CTY67 sect0 (14,24) 龍之女王:給光之珠 0x65(handler L0x5e02)。對抗索瑪關鍵道具。 */
  {  52, 67, 0x65, DQ3_SC_NOITEM, DQ3_SC_NOITEM, 0,                 71, 71, 71 },
  /* CTY16 sect0 (33,24) 獲救劇情 NPC(L0x6646):與卡爾洛斯重逢答謝 → 給誘惑之劍 0x10(女性專用)。 */
  {  84, 16, 0x10, DQ3_SC_NOITEM, DQ3_SC_NOITEM, 0,                 98, 99, 98 },
  /* 巴哈拉達 CTY15 sect0 (5,24) 胡椒商古布達(L0x5719):獲救後給黑胡椒 0x5c(取船材料)。 */
  {  25, 15, 0x5c, DQ3_SC_NOITEM, DQ3_SC_NOITEM, 0,                 119, 118, 120 },
  /* CTY64 sect0 (16,10)(L0x5d70):「粉碎大魔王陰謀」→ 給銀寶珠 0x6b。 */
  {  49, 64, 0x6b, DQ3_SC_NOITEM, DQ3_SC_NOITEM, 0,                 85, 84, 85 },

  /* ── 檢查型(give_item==NONE,require_item != NONE;持物→success rec、否則→need rec,不消耗)── */
  /* 精靈之村 CTY5 sect0 (17,7)(L0x5567,flag 0x30):需持夢幻紅寶石 0x59 → 反應 rec90,否則 rec47。 */
  {  16,  5, DQ3_SC_NOITEM, DQ3_SC_NOITEM, 0x59, 0,                 47, 90, 90 },
  /* CTY54 sect0 (8,2)(L0x5c20,flag 0x43):需持變身杖 0x62 → 反應 rec56,否則 rec61。 */
  {  44, 54, DQ3_SC_NOITEM, DQ3_SC_NOITEM, 0x62, 0,                 61, 56, 56 },
  ...
  {  50, 0xff, DQ3_SC_NOITEM, DQ3_SC_NOITEM, 0x5b, 0,               89, 87, 87 },
};
