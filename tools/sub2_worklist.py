...
# 已接:給予 7/12/25/31/49/52/84;特例 9(Romaly 收皇冠)/26(Portoga 胡椒換船);檢查 16/44/50。
# (提頓村綠寶珠給予是 sub=0 特例非 sub2;祭壇 63-68 為旗標型 stub。)
WIRED={7,12,25,31,49,52,84,9,26,16,44,50}
