...
chk "盜賊鑰匙:拿吉米老人(給+rec52)" "warp:8:9:10:3"   "ue"   "byte4=12:獲得道具 0x55"
chk "拿吉米條件對話:已有鑰匙後話"  "item:0x55;warp:8:9:10:3" "ue" "byte4=12:已給過 → 後話 rec53"
chk "魔法玉:雷貝 2F 老人(需鑰匙)" "item:0x55;warp:1:3:4:1" "ue" "byte4=7:獲得道具 0x58"
chk "羅馬利亞:持皇冠還國王"       "item:0x33;warp:2:7:3:1" "ue" "羅馬利亞國王:歸還金皇冠"
chk "水槍:CTY22 sect1 NPC(給+rec46)" "warp:22:4:4:1"  "le"   "byte4=31:獲得道具 0x4b"
