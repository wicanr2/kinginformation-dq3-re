...
`0.1.26`、`dq3_cht` content `0.1.29`；不要把本段早期的版本號當成現行值。IDA Pro 9.4 證明商人聚落 `(210,64)`
...
同狀態 V3。game-pack schema 現為 `0.1.26`；不得把此前 `0.1.22`／`0.1.23`／`0.1.24`／`0.1.25` 歷史段落當成目前版本。
...
已完成。現行 pack schema `0.1.26`、content `0.1.29`。
